...
class MoodleApi():
    ...
    def criar_token(self, usuario, senha):
        request_token = requests.get('https://www.moodle.ufrgs.br/login/token.php?username='+ usuario + '&password='+ urllib.parse.quote(senha.encode('utf8')) + '&service=moodle_mobile_app')
